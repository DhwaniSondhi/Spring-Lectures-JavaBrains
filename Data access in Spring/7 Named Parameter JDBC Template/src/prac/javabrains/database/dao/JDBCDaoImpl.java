...
public class JDBCDaoImpl {
	...
	/*
		Its not recommended to use both JdbcTemplate and NamedParameterJdbcTemplate together, in that case using 
		SimpleJdbcTemplate(not in 4.3.26 but present in 3.2.*) that includes simple very useful functions...
	*/	
